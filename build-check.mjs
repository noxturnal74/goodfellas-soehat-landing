...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "goodfellas"') || !html.includes('data-motion-profile="goodfellas"')) {
...
console.log("GoodFellas Barbershop Soehat brand-DNA build check passed.");
